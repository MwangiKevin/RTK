...
<script type="text/javascript">
	$(document).ready(function (e){
		...
		get_percentages(0,null);
		get_percentages_labels(0);
		get_stock_summary(1);
		...
		function get_highest_stocks(comm){
			...
			var url = "<?php echo base_url() . 'Rtk_reports_management/get_highest_stocks/0/'; ?>";
			var my_url = url+comm;
		...
		function get_highest_expiries(comm){
			...
			var url = "<?php echo base_url() . 'Rtk_reports_management/get_highest_expiries/0/'; ?>";
			var my_url = url+comm;
			var oTable_name = tbl_name;
			oTable_name = $('#'+tbl_name).dataTable(
			{	
